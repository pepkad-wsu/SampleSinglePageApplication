...
public partial class DataAccess
{
    ...
    public async Task<DataObjects.BooleanResponse> SaveUDFLabels(Guid TenantId, List<DataObjects.udfLabel> labels)
    {
        ...
        if (labels != null && labels.Count() > 0) {
            ...
            foreach (var label in save) {
                ...
                try {
                    ...
                    output.Messages.Add("Error Saving UDF Label '" + label.Id.ToString() + "' - " + ex.Message);
                }
            }
        }
